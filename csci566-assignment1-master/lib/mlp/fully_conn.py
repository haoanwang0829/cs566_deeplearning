...
class TestFCReLU(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="TestFCReLU_flatten"),
            fc(20, 10, 5e-2, name="TestFCReLU_fc"),
            relu(name="TestFCReLU_relu")
            ########### END ###########
        )
...
class SmallFullyConnectedNetwork(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        self.net = sequential(
            ########## TODO: ##########
            fc(4, 30, 0.02, name="SmallFully_fc1"),
            relu(name="SmallFully_relu1"),
            fc(30, 7, 0.02, name="SmallFully_fc2"),
            relu(name="SmallFully_relu2")
            ########### END ###########
        )
...
class TinyNet(Module):
    def __init__(self, keep_prob=0, dtype=np.float32, seed=None):
        ...
        self.net = sequential(
            ########## TODO: ##########
            flatten(name="TinyNet_flat"),
            fc(3072, 400, 0.001, name="TinyNet_fc1"),
            relu(name="TinyNet_relu"),
            fc(400, 10,name="TinyNet_fc2")
            ########### END ###########
        )
